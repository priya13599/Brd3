...
public class CheckValidations {
	...
	public boolean DataLength(CustomerDetails customer)
    {
	...
	public boolean MandatoryFields(CustomerDetails customer)
	{
	...
	public boolean DataType(CustomerDetails customer)
	{
		boolean i13=false;
		boolean i15 = false;
